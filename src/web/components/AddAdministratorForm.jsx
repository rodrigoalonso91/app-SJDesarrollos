...
export const AddAdministratorForm = ({ collection }) => {
	...
	const color = useField({ type: "color", label: 'Color', placeholder: 'Ej: #40ff00' })

	const inputs = [ firstname, lastname, phone, email, color ]
